...
import sampleImage from "public/bappam-logo.png";

const LandingPage = (props: any) => {
  const { onEnterBtnClickHandler } = props;
  return (
    <div className="border-0 border-white z-[9999999999999999] absolute top-0 right-0 bottom-0 left-0 h-dvh   bg-slate-800 flex justify-center align-middle ">
      <div className="container border shadow-2xl border-slate-700 md:w-2/6 lg:w-2/6 m-auto rounded-md relative">
        ...
        <h1 className="text-center text-xs mt-4 text-slate-100">bappamtv</h1>
        ...
        <div className="text-center">
          ...
          <button
            ...
            onClick={() => onEnterBtnClickHandler()}
          >
            Enter
          </button>
          <p className="w-5/6 m-auto mb-8">
            Watch and Download bappamtv Telugu movies New 2024 in an excellent quality @ smallest file size. Developed
